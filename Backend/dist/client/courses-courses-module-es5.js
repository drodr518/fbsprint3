...
var AssessmentComponent = /** @class */ (function () {
    function AssessmentComponent(routes) {
        this.routes = routes;
        this.items = [
    ...
    AssessmentComponent.prototype.nextQuestion = function () {
        this.select = this.select + 1;
        this.loadItem();
    };
    AssessmentComponent.prototype.canNext = function () {
        return this.select < this.items.length - 1;
    };
    AssessmentComponent.prototype.prevQuestion = function () {
        this.select = this.select - 1;
        this.loadItem();
    };
    AssessmentComponent.prototype.loadItem = function () {
        this.item = this.items[this.select];
        this.response = this.items[this.select].response;
    };
    AssessmentComponent.prototype.submit = function () {
        this.items[this.select].response = this.response.toString();
    };
    AssessmentComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.subscriptions.push(this.routes.queryParams.subscribe(function (params) {
            if (params.course) {
                _this.current_course = params.course;
            }
            if (params.id) {
                _this.assessment_id = params.id;
            }
        }));
    };
...
var CourseComponent = /** @class */ (function () {
    function CourseComponent(route, userServices, coursesServices, router) {
        this.route = route;
    ...
    CourseComponent.prototype.loadData = function () {
        ...
        this.subscriptions.push(this.userServices.studentHasCourse(this.user_id, this.current_course).subscribe(function (resp) {
            _this.authorized = resp;
            if (_this.authorized) {
                _this.subscriptions.push(_this.coursesServices
                    .getCourseInfo(_this.current_course)
    ...
    CourseComponent.prototype.setNav = function (val) {
        this.navItem = val;
    };
    CourseComponent.prototype.isEqual = function (val) {
        return this.navItem === val;
    };
    CourseComponent.prototype.ngOnChanges = function () {
        this.ngOnInit();
    };
    CourseComponent.prototype.isAdmin = function () {
...
var DiscussionEditorComponent = /** @class */ (function () {
    function DiscussionEditorComponent() {
    }
...
var DiscussionComponent = /** @class */ (function () {
    function DiscussionComponent(route, coursesServices, userServices, router) {
        this.route = route;
        this.coursesServices = coursesServices;
        this.userServices = userServices;
        this.router = router;
    ...
    DiscussionComponent.prototype.ngOnInit = function () {
        ...
        this.subscriptions.push(this.route.queryParams.subscribe(function (params) {
            if (params.discussion) {
                _this.id = params.discussion;
            }
            if (params.start) {
                _this.startFrom = Number(params.start);
            }
        }));
        this.loadDiscussion();
    };
    // adds post to discussion and reloads posts
    DiscussionComponent.prototype.pushPost = function () {
        var _this = this;
        var post = {
        ...
        this.subscriptions.push(this.coursesServices.postDiscussionPost(this.current_course, this.id, post).subscribe(function (resp) {
            console.log(resp);
            if (resp) {
                _this.totalPosts++;
                _this.lastPage();
    ...
    DiscussionComponent.prototype.loadDiscussion = function () {
        var _this = this;
        this.replying = false;
        this.htmlContent = '';
        this.subscriptions.push(this.coursesServices.getDiscussionInfo(this.current_course, this.id).subscribe(function (resp) {
            _this.description = resp.description;
            _this.title = resp.title;
            _this.isClosed = resp.isClosed;
        }));
        this.subscriptions.push(this.coursesServices.getDiscussionPosts(this.current_course, this.id, this.startFrom).subscribe(function (resp) {
            if (resp.posts.length > 0) {
                _this.posts = resp.posts;
                _this.totalPosts = resp.total;
            }
        }));
    };
    DiscussionComponent.prototype.isAdmin = function () {
        return this.userServices.getIsAdmin();
    };
    // allows the new post editor to display
    DiscussionComponent.prototype.openEditor = function () {
        this.replying = true;
    };
    // disables the new post editor to display
    DiscussionComponent.prototype.closeEditor = function () {
        this.replying = false;
    };
    // true is post is empty
    DiscussionComponent.prototype.isPostEmpty = function () {
        return this.htmlContent == '';
    };
    // runs if input values change, current_course
    DiscussionComponent.prototype.ngOnChanges = function () {
        this.ngOnInit();
    };
    // can only go to a previous page if current start position is not in the first page.
    DiscussionComponent.prototype.canBack = function () {
        return this.startFrom >= POST_PER_PAGE;
    };
    // navigates to the previous discussion posts page
    DiscussionComponent.prototype.back = function () {
        this.startFrom += -(POST_PER_PAGE);
        this.setParams();
    };
    // true if not on first page
    DiscussionComponent.prototype.canNext = function () {
        return (this.startFrom + POST_PER_PAGE) < this.totalPosts;
    };
    // navigates to next page of discussion posts
    DiscussionComponent.prototype.next = function () {
        this.startFrom += (POST_PER_PAGE);
        this.setParams();
    };
    // navigates to first page of discussion posts
    DiscussionComponent.prototype.firstPage = function () {
        this.startFrom = 0;
        this.setParams();
    };
    //navigates to the last page of discussion posts
    DiscussionComponent.prototype.lastPage = function () {
    ...
    DiscussionComponent.prototype.setParams = function () {
...
var DiscussionsComponent = /** @class */ (function () {
    function DiscussionsComponent(coursesServices, userServices) {
        this.coursesServices = coursesServices;
        this.userServices = userServices;
        this.discussions = [];
        this.subscriptions = [];
    ...
    DiscussionsComponent.prototype.loadDiscussions = function () {
        var _this = this;
        this.subscriptions.push(this.coursesServices.getDiscussions(this.current_course).subscribe(function (resp) {
            _this.discussions = resp;
        }));
    };
    DiscussionsComponent.prototype.isAdmin = function () {
        return this.userServices.getIsAdmin();
    };
    // Runs whenever input values change
    DiscussionsComponent.prototype.ngOnChanges = function () {
        this.ngOnInit();
    };
    DiscussionsComponent.ctorParameters = function () { return [
        { type: _courses_service__WEBPACK_IMPORTED_MODULE_2__["CoursesService"] },
        { type: _user_service__WEBPACK_IMPORTED_MODULE_1__["UserService"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
var NewDiscussionComponent = /** @class */ (function () {
    function NewDiscussionComponent() {
    }
    NewDiscussionComponent.prototype.ngOnInit = function () {
    };
...
var GradesComponent = /** @class */ (function () {
    function GradesComponent(userServices, coursesServices) {
        this.userServices = userServices;
        this.coursesServices = coursesServices;
    ...
    GradesComponent.prototype.loadGrades = function () {
        var _this = this;
        this.subscriptions.push(this.coursesServices.getStudentCourseGrades(this.current_course, this.debugUser).subscribe(function (resp) {
            _this.dataSource = resp;
        }));
    };
    GradesComponent.prototype.getPercent = function () {
        var total = this.dataSource.map(function (data) { return data.outOf; }).reduce(function (acc, value) { return (acc + value); }, 0.0);
        if (total < 0)
            return 0;
        return this.dataSource.map(function (data) { return data.score; }).reduce(function (acc, value) { return (acc + value); }, 0.0) / total;
    };
...
var CourseDetailEditorComponent = /** @class */ (function () {
    function CourseDetailEditorComponent() {
    }
    CourseDetailEditorComponent.prototype.ngOnInit = function () {
    };
    ...
    return CourseDetailEditorComponent;
}());
...
var InfoComponent = /** @class */ (function () {
    function InfoComponent(courseServices, userServices) {
    ...
    InfoComponent.prototype.ngOnInit = function () {
        ...
        this.subscriptions.push(this.courseServices.getInstructorInfo(this.courseData.instructor).subscribe(function (resp) {
            _this.instructor = resp.name;
            _this.instructorEmail = resp.contactEmail;
        }));
    };
    InfoComponent.prototype.isAdmin = function () {
        return this.userServices.getIsAdmin();
    };
...
var ModuleEditorComponent = /** @class */ (function () {
    function ModuleEditorComponent() {
    }
...
var ModulesComponent = /** @class */ (function () {
    function ModulesComponent(coursesServices, userServices) {
        this.coursesServices = coursesServices;
        this.userServices = userServices;
        this.modules = [];
        this.subscriptions = [];
    }
    ModulesComponent.prototype.openInNewTab = function (url) {
        window.open(url, "_blank");
    };
    ModulesComponent.prototype.isAdmin = function () {
        return this.userServices.getIsAdmin();
    };
    ModulesComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.subscriptions.push(this.coursesServices.getModules(this.current_course).subscribe(function (resp) {
            _this.modules = resp;
            //console.log(resp);
        }));
    };
...
var NewContentComponent = /** @class */ (function () {
    function NewContentComponent() {
    }
    NewContentComponent.prototype.ngOnInit = function () {
    };
...
/* harmony import */ var _kolkov_angular_editor__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @kolkov/angular-editor */ "./node_modules/@kolkov/angular-editor/fesm5/kolkov-angular-editor.js");
...
var CoursesService = /** @class */ (function () {
    ...
    CoursesService.prototype.getCourseInfo = function (course_id) {
        var params = { params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set('key', "" + course_id) };
    ...
    CoursesService.prototype.getDiscussions = function (course_id) {
        var params = { params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set('course', "" + course_id) };
    ...
    CoursesService.prototype.getModules = function (course_id) {
        var params = { params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set('course', "" + course_id) };
    ...
    CoursesService.prototype.getDiscussionPosts = function (course_id, discussion_id, startFrom) {
        var params = { params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set('course', "" + course_id).set('discussion', "" + discussion_id).set('start', "" + startFrom) };
    ...
    CoursesService.prototype.getDiscussionInfo = function (course_id, discussion_id) {
        var params = { params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set('course', "" + course_id).set('discussion', "" + discussion_id) };
    ...
    CoursesService.prototype.getStudentCourseGrades = function (course_id, student_id) {
        var params = { params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set('course', "" + course_id).set('student', "" + student_id) };
    ...
    CoursesService.prototype.getInstructorInfo = function (instructor_id) {
        var params = { params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set('id', "" + instructor_id) };
    ...
    CoursesService.prototype.postDiscussionPost = function (course_id, discussion_id, post) {
