...
var routes = [
    { path: '', component: _main_main_component__WEBPACK_IMPORTED_MODULE_1__["MainComponent"], children: [
            ...
            { path: 'dashboard', loadChildren: function () { return __webpack_require__.e(/*! import() | dashboard-dashboard-module */ "dashboard-dashboard-module").then(__webpack_require__.bind(null, /*! ../dashboard/dashboard.module */ "./src/app/dashboard/dashboard.module.ts")).then(function (mod) { return mod.DashboardModule; }); } },
            { path: 'helppage', loadChildren: function () { return __webpack_require__.e(/*! import() | helppage-helppage-module */ "helppage-helppage-module").then(__webpack_require__.bind(null, /*! ../helppage/helppage.module */ "./src/app/helppage/helppage.module.ts")).then(function (mod) { return mod.HelppageModule; }); } },
...
var NavbarComponent = /** @class */ (function () {
    function NavbarComponent(userServices) {
     ...
     */
    NavbarComponent.prototype.loadCourses = function () {
        var _this = this;
        this.subscriptions.push(this.userServices.getStudentCourses(this.student_id).subscribe(function (resp) {
            _this.myCourses = resp;
        }));
    };
    NavbarComponent.prototype.toggleAdmin = function () {
